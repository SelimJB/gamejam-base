...
{
	[CreateAssetMenu(menuName = "ScriptableObjects/Achievements/Conditions/Value Cumulative Condition", fileName = "ValueCumulativeCondition")]
	public class ValueCumulativeCondition : AchievementCondition
	{
